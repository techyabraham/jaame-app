...
class TransactionTatumScreen extends StatelessWidget {
  TransactionTatumScreen({super.key});
      ...
      child: ResponsiveLayout(
        mobileScaffold: Scaffold(
          ...
          appBar: PrimaryAppBar(
            title: controller.tatumModel.data.addressInfo.coin,
          ),
      ...
      child: ListView(
        ...
        children: [
          CryptoAddressInfoWidget(
            address: controller.tatumModel.data.addressInfo.address,
          ),
