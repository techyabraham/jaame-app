...
final languageSettingsController = Get.put(LanguageSettingController(), permanent: true);
//  (Strings.donateNow)
...
class LanguageSettingController extends GetxController {
  ...
  Future<void> fetchLanguages() async {
    debugPrint("--------------------");
    debugPrint("Language Fetch Start");
  ...
  void changeLanguage(String newLanguage) {
    ...
    //     ? Get.find<DashboardController>().guestDashboard()
